...
ABC_PAIR_YES_NO_TAILS = (
    ...
    "After resolving both ABC scores by key signature, give one word: 'yes' or 'no'.",
    "Resolve both ABC scores using their key signatures, then respond with one lowercase word: 'yes' or 'no'.",
)
